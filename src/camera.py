...
class DeviceMetadata:
    Name = "Ximea Camera"
    Version = "1.0.0"
    Description = "Ximea Camera ASCOM Alpaca Driver via xiAPI"
    DeviceType = "Camera"
...
async def electronsperadu(devnum: int, params: AlpacaGetParams = Depends()):
    get_device(devnum)
    # xiAPI does not report a sensor e-/ADU figure.
    return PropertyResponse.create(
        value=None,
        client_transaction_id=params.client_transaction_id,
